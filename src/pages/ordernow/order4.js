...
export default function Order4() {
    ...
    <Accordion.Item key={s.value} value={s.value}>
      <Accordion.Control>
        <div className="d-flex">
          <Image
            src={`./img/ordernow/order4/${s.color}.avif`}
      ...
      <Accordion.Panel>
        <Image
          src={`./img/ordernow/order4/${s.image1}.png`}
          className="img-fluid"
        />
      </Accordion.Panel>
    </Accordion.Item>
  ...
  const cars = cardata.map((car) => (
    <Accordion.Item key={car.value} value={car.value}>
      <Accordion.Control>
        <div className="d-flex">
          <Image
            src={`./img/ordernow/order4/${car.color}.avif`}
            className="img-fluid w-25"
          />
          <p className="d-flex justify-content-center align-items-center">
            {car.value}
      ...
      <Accordion.Panel>
        <Image
          src={`./img/ordernow/order4/${car.image1}.png`}
          className="img-fluid"
        />
        <Image
          src={`./img/ordernow/order4/${car.image2}.png`}
          className="img-fluid"
        />
      </Accordion.Panel>
    </Accordion.Item>
  ...
  const items = groceries.map((item) => (
    <Accordion.Item key={item.value} value={item.value}>
      <Accordion.Control className="bg-light text-dark">
        {item.value}
      </Accordion.Control>
        ...
        <Grid.Col span={{ base: 12, md: 6, lg: 8 }} className="mt-3 left">
          <div className="carousel-container">
            <Carousel
              ...
              <Carousel.Slide>
                <Image
                  src="./img/ordernow/order3/1.png"
                  className="img-fluid"
                />
              </Carousel.Slide>
              <Carousel.Slide>
                <Image
                  src="./img/ordernow/order3/2.png"
                  className="img-fluid"
                />
              </Carousel.Slide>
              <Carousel.Slide>
                <Image
                  src="./img/ordernow/order3/3.png"
                  className="img-fluid"
                />
              </Carousel.Slide>
              <Carousel.Slide>
                <Image
                  src="./img/ordernow/order3/12.png"
                  className="img-fluid"
                />
              </Carousel.Slide>
              <Carousel.Slide>
                <Image
                  src="./img/ordernow/order3/13.png"
                  className="img-fluid"
                />
              </Carousel.Slide>
            </Carousel>
            ...
            <Carousel
              ...
              <Carousel.Slide withIndicators>
                <Grid>
                  <Grid.Col span={{ base: 12, md: 6, lg: 8 }}>
                    <div>
                      <Image
                        src="./img/ordernow/order4/1-1.avif"
              ...
              <Carousel.Slide>
                <Grid>
                  <Grid.Col span={{ base: 12, md: 6, lg: 8 }}>
                    <Image
                      src="./img/ordernow//order4/1-2.avif"
                      className="img-fluid w-75"
                    />
                  </Grid.Col>
                  <Grid.Col
              ...
              <Carousel.Slide>
                <Grid>
                  <Grid.Col
                    ...
                    <Image
                      src="./img/ordernow//order4/1-3.avif"
                      className="img-fluid w-75"
                    />
                  </Grid.Col>
                  <Grid.Col
              ...
              <Carousel.Slide>
                <Grid>
                  <Grid.Col
                    ...
                    style={{ position: "relative", overflow: "hidden" }}>
                    <Image
                      src="./img/ordernow//order4/1-4.avif"
                      className="img-fluid w-75"
                    />
                  </Grid.Col>
                  <Grid.Col
              ...
              <Carousel.Slide>
                <Grid>
                  <Grid.Col
                    ...
                    style={{ position: "relative", overflow: "hidden" }}>
                    <Image
                      src="./img/ordernow//order4/1-5.avif"
                      className="img-fluid w-75"
                    />
                  </Grid.Col>
                  <Grid.Col
              ...
              <Carousel.Slide>
                <Grid>
                  <Grid.Col
                    ...
                    style={{ position: "relative", overflow: "hidden" }}>
                    <Image
                      src="./img/ordernow//order4/1-6.avif"
                      className="img-fluid w-75"
                    />
                  </Grid.Col>
                  <Grid.Col
            ...
            <Carousel
              ...
              <Carousel.Slide withIndicators>
                <Grid>
                  <Grid.Col span={{ base: 12, md: 6, lg: 8 }}>
                    <div>
                      <Image
                        src="./img/ordernow/order4/2-1.avif"
                        className="img-fluid"
                      />
                    </div>
                  </Grid.Col>
              ...
              <Carousel.Slide>
                <Grid>
                  <Grid.Col span={{ base: 12, md: 6, lg: 8 }}>
                    <Image
                      src="./img/ordernow/order4/2-2.avif"
                      className="img-fluid"
                    />
                  </Grid.Col>
                  <Grid.Col
              ...
              <Carousel.Slide>
                <Grid>
                  <Grid.Col span={{ base: 12, md: 6, lg: 8 }}>
                    <Image
                      src="./img/ordernow/order4/2-3.avif"
                      className="img-fluid"
                    />
                  </Grid.Col>
                  <Grid.Col
              ...
              <Carousel.Slide>
                <Grid>
                  <Grid.Col span={{ base: 12, md: 6, lg: 8 }}>
                    <Image
                      src="./img/ordernow/order4/2-4.avif"
                      className="img-fluid"
                    />
                  </Grid.Col>
                  <Grid.Col
              ...
              <Carousel.Slide>
                <Grid>
                  <Grid.Col span={{ base: 12, md: 6, lg: 8 }}>
                    <Image
                      src="./img/ordernow/order4/2-5.avif"
                      className="img-fluid"
                    />
                  </Grid.Col>
                  <Grid.Col
              ...
              <Carousel.Slide>
                <Grid>
                  <Grid.Col span={{ base: 12, md: 6, lg: 8 }}>
                    <Image
                      src="./img/ordernow/order4/2-6.avif"
                      className="img-fluid"
                    />
                  </Grid.Col>
                  <Grid.Col
