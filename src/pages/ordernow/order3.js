...
export default function Order3() {
  ...
  const seats = carseat.map((s) => (
    <Accordion.Item key={s.value} value={s.value}>
      ...
      <Accordion.Panel>
        <Image
          src={`./img/ordernow/order2/${s.image1}.png`}
          className="img-fluid"
        />
      </Accordion.Panel>
    </Accordion.Item>
  ...
  const cars = cardata.map((car) => (
    <Accordion.Item key={car.value} value={car.value}>
      ...
      <Accordion.Panel>
        <Image
          src={`./img/ordernow/order3/${car.image1}.png`}
          className="img-fluid"
        />
        <Image
          src={`./img/ordernow/order3/${car.image2}.png`}
          className="img-fluid"
        />
      </Accordion.Panel>
    </Accordion.Item>
            ...
            <Carousel
              ...
              <Carousel.Slide withIndicators>
                <Grid>
                  <Grid.Col span={{ base: 12, md: 6, lg: 8 }}>
                    <div>
                      <Image
                        src="./img/ordernow/order3/1-1.avif"
              ...
              <Carousel.Slide>
                <Grid>
                  <Grid.Col span={{ base: 12, md: 6, lg: 8 }}>
                    <Image
                      src="./img/ordernow//order3/1-2.avif"
                      className="img-fluid w-75"
                    />
                  </Grid.Col>
                  <Grid.Col
              ...
              <Carousel.Slide>
                <Grid>
                  <Grid.Col
                    ...
                    <Image
                      src="./img/ordernow//order3/1-3.avif"
                      className="img-fluid w-75"
                    />
                  </Grid.Col>
                  <Grid.Col
              ...
              <Carousel.Slide>
                <Grid>
                  <Grid.Col
                    ...
                    style={{ position: "relative", overflow: "hidden" }}>
                    <Image
                      src="./img/ordernow//order3/1-4.avif"
                      className="img-fluid w-75"
                    />
                  </Grid.Col>
                  <Grid.Col
              ...
              <Carousel.Slide>
                <Grid>
                  <Grid.Col
                    ...
                    style={{ position: "relative", overflow: "hidden" }}>
                    <Image
                      src="./img/ordernow//order3/1-5.avif"
                      className="img-fluid w-75"
                    />
                  </Grid.Col>
                  <Grid.Col
              ...
              <Carousel.Slide>
                <Grid>
                  <Grid.Col
                    ...
                    style={{ position: "relative", overflow: "hidden" }}>
                    <Image
                      src="./img/ordernow//order3/1-6.avif"
                      className="img-fluid w-75"
                    />
                  </Grid.Col>
                  <Grid.Col
            ...
            <Carousel
              ...
              <Carousel.Slide withIndicators>
                <Grid>
                  <Grid.Col span={{ base: 12, md: 6, lg: 8 }}>
                    <div>
                      <Image
                        src="./img/ordernow/order3/2-1.avif"
                        className="img-fluid"
                      />
                    </div>
                  </Grid.Col>
              ...
              <Carousel.Slide>
                <Grid>
                  <Grid.Col span={{ base: 12, md: 6, lg: 8 }}>
                    <Image
                      src="./img/ordernow/order3/2-2.avif"
                      className="img-fluid"
                    />
                  </Grid.Col>
                  <Grid.Col
              ...
              <Carousel.Slide>
                <Grid>
                  <Grid.Col span={{ base: 12, md: 6, lg: 8 }}>
                    <Image
                      src="./img/ordernow/order3/2-3.avif"
                      className="img-fluid"
                    />
                  </Grid.Col>
                  <Grid.Col
              ...
              <Carousel.Slide>
                <Grid>
                  <Grid.Col span={{ base: 12, md: 6, lg: 8 }}>
                    <Image
                      src="./img/ordernow/order3/2-4.avif"
                      className="img-fluid"
                    />
                  </Grid.Col>
                  <Grid.Col
              ...
              <Carousel.Slide>
                <Grid>
                  <Grid.Col span={{ base: 12, md: 6, lg: 8 }}>
                    <Image
                      src="./img/ordernow/order3/2-5.avif"
                      className="img-fluid"
                    />
                  </Grid.Col>
                  <Grid.Col
              ...
              <Carousel.Slide>
                <Grid>
                  <Grid.Col span={{ base: 12, md: 6, lg: 8 }}>
                    <Image
                      src="./img/ordernow/order3/2-6.avif"
                      className="img-fluid"
                    />
                  </Grid.Col>
                  <Grid.Col
